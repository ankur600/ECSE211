...
# Random tone
tone1 = Sound(duration=5, volume=200, pitch=1, mod_f="C3", mod_k=1)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(color_name_index)
        print(TOUCH_SENSOR.is_pressed())
        if color_name_index == 50:
            print("_one play")
            tone1.play()
            continue
        elif color_name_index != 50:
            rotation = increment_motor(color_name_index)
            platform_return_motor(color_name_index)        
    reset_brick()
